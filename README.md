...
| `src/kept/KeptAccountMenu.tsx` | Menu under your name: To do, light/dark mode, Settings, Referral, Sign out |
| `src/kept/KeptTodo.tsx` | Next steps, suggestions and your own tasks (signed in) |
| `src/kept/KeptAccountPages.tsx` | Settings and Referral (coming soon) |
| `src/kept/theme.ts` | Light, dark or match-system mode |
